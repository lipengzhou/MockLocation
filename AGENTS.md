...
- 当前正式版：`versionName=1.1`，`versionCode=2`
- 最低系统版本：`minSdk=31`，即 Android 12+
- 构建产物路径：`build/release/MockLocation-1.1-release.apk`
...
release.apkName=MockLocation-1.1-release.apk
```
...
adb install build/release/MockLocation-1.1-release.apk
```
