...
- 当前正式版：`versionName=1.2`，`versionCode=3`
- 最低系统版本：`minSdk=31`，即 Android 12+
- 构建产物路径：`build/release/MockLocation-1.2-release.apk`
...
release.apkName=MockLocation-1.2-release.apk
```
...
adb install build/release/MockLocation-1.2-release.apk
```
